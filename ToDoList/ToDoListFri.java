...
public class ToDoListFri extends JFrame{
    ...
    public ToDoListFri(){
        ...
        JButton buttonWeekend = new JButton(">Weekend");
        buttonWeekend.setBounds(420, 400, 110, 25);
       ...
       //adding components to frame2 
        ...
        buttonWeekend.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                
                if(e.getSource() == buttonWeekend){
                    dispose();
                    new ToDoListWeekend();
                }
            }
        ...
        saveToFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    BufferedWriter writer = new BufferedWriter(new FileWriter("Output_Fri.txt"));
        ...
        retrieveFile.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    BufferedReader reader = new BufferedReader(new FileReader("Output_Fri.txt"));
